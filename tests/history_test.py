...
def test_get_calculation_last_result(clear_history_fixture, setup_addition_calculation_fixture):
...
def test_get_calculation_first_result(clear_history_fixture, setup_addition_calculation_fixture):
